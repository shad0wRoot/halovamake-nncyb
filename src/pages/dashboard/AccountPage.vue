...
<template>
  <section class="px-4 lg:px-6">
    <div class="border rounded-lg p-6">
      <h2 class="text-foreground text-xl font-semibold">Account</h2>
      <p class="text-muted-foreground mt-2 text-sm">Manage your profile and personal account details.</p>
    </div>
  </section>
</template>
